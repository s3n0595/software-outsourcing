<template >
  ...
  <div class="form">
    ...
    >
      <el-form-item label="原密码" prop="employerPassword">
        <el-input type="password" v-model="ruleForm.employerPassword" autocomplete="off"></el-input>
      </el-form-item>
      ...
      <el-form-item prop="employerId">
        <el-input type="hidden" v-model="ruleForm.employerId"></el-input>
      </el-form-item>
    </el-form>
  </div>
</template>
  ...
  methods: {
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          // alert('submit!');
          this.$axios.post("/empcenter/updatePwd",
              this.$qs.stringify({
                "employerPassword":this.ruleForm.employerPassword,
